...
public class PLPSteps {
	...
	public void steel_products_are_displayed() {
			...
			Assert.assertEquals(productlandingpage.validatePLPListResults(), "Mild Steel");

	}
	
	@Then("HR Products are displayed")
	public void hr_products_are_displayed() {
		Assert.assertEquals(productlandingpage.validatePLPListResults(), "Hot Rolled Mild Steel Sheets");
	}
	...
	public void breadcrump_should_display_home_metals_and_alloys_steel() {
		...
		Assert.assertEquals(productlandingpage.validatePLPBreadCrumb(), "Mild Steel");
	}
	...
	@Then("click on clearFilter")
	public void click_on_clearFilter() {
		productlandingpage.clickClearFilter();
	}
